...
-   SIMD usage compatible in nightly for dapa-hash
...
Daemon:
- POW `dapa-hash` algorithm released
- Bug fixes 
...
**NOTE**: Previous versions were not documented correctly, only commits history and small PR for features-specific were created, please see them [here](https://github.com/dapa-project/dapa-blockchain/pulls?q=is%3Apr+is%3Aclosed).