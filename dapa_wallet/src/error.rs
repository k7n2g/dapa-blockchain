...
use dapa_common::rpc_server::InternalRpcError;
...
pub enum WalletError {
    ...
    #[error("Your wallet don't have enough funds to pay fees: expected {} but have only {}", format_dapa(*_0), format_dapa(*_1))]
    ...
    #[error("Invalid fees provided, minimum fees calculated: {}, provided: {}", format_dapa(*_0), format_dapa(*_1))]
