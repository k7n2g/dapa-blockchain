...
pub const DEFAULT_DAEMON_ADDRESS: &str = "http://node.dapahe.com:20101";
...
#[clap(version = VERSION, about = "DAPA Cryptocurrency a BlockDAG, with Homomorphic Encryption, Zero-Knowledge Proofs, and Smart Contracts.")]
