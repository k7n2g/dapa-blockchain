...
pub struct LogConfig {
    ...
    /// If disabled, the log file will be named dapa-wallet.log instead of YYYY-MM-DD.dapa-wallet.log
    #[clap(long)]
    #[serde(default)]
    ...
    /// Log filename
    /// 
    /// By default filename is dapa-wallet.log.
    /// File will be stored in logs directory, this is only the filename, not the full path.
    /// Log file is rotated every day and has the format YYYY-MM-DD.dapa-wallet.log.
    #[clap(long, default_value_t = String::from("dapa-wallet.log"))]
