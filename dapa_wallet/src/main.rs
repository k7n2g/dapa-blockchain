...
#[clap(version = VERSION, about = "DAPA Advanced Cryptocurrency built from scratch with BlockDAG, Homomorphic Encryption, Zero-Knowledge Proofs, and Smart Contracts.")]
