...
mod tests {
    ...
    fn test_hr_balance_proof() {
        ...
        let shareable = HumanReadableProof::Balance { proof, asset: DAPA_ASSET, topoheight: 0 };
    ...
    fn test_hr_ownership_proof() {
        ...
        let shareable = HumanReadableProof::Ownership { proof, asset: DAPA_ASSET, topoheight: 0 };
