...
pub const FEE_PER_KB: u64 = 00100;
// 0.00100000 DAPA COIN per account creation
// User can create an account with 0.001 DAPA COIN
...
pub const FEE_PER_MULTISIG_SIGNATURE: u64 = 100;
...
pub const TRANSACTION_FEE_BURN_PERCENT: u64 = 1;
