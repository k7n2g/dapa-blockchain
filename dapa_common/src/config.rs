...
// Contracts rules
// 1 DAPA per contract deployed
// Each contract deployed has a overhead of 1 DAPA
...
// Each read operation has a fixed cost of 0.00000200 DAPA
