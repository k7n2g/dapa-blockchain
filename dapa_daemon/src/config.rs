...
pub const NETWORK_ID: [u8; NETWORK_ID_SIZE] = [0x15, 0x3c, 0x26, 0x36, 0x23, 0x2f, 0x19, 0x62, 0x9c, 0x42, 012, 0x5f, 0x38, 0x5c, 0x7f, 0x77];
...
// BlockDAG rules
pub const STABLE_LIMIT: u64 = 8; // The height to consider the block stable

// Emission rules
pub const DEV_FEES: [DevFeeThreshold; 2] = [
    // Activated for 0 blocks
    DevFeeThreshold {
        height: 0,
        fee_percentage: 0
    },
    ...
    DevFeeThreshold {
        // 0 blocks * 15s of block time / 60s / 60m / 24h / 365d = 1.5 years
        height: 0, 
        fee_percentage: 0
    }
];
