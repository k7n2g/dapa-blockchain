...
pub const NETWORK_ID: [u8; NETWORK_ID_SIZE] = [0x76, 0x6c, 0x23, 0x54, 0x55, 0x7c, 0x21, 0x36, 0x8c, 0x66, 0x72, 0x3f, 0x69, 0x5c, 0x7f, 0x32];
...
pub const EMISSION_SPEED_FACTOR: u64 = 24;
