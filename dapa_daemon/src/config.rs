...
pub const NETWORK_ID: [u8; NETWORK_ID_SIZE] = [0x17, 0x2c, 0x4, 0x31, 0x11, 0x4f, 0x44, 0x27, 0x9c, 0x19, 0x75, 0x4f, 0x73, 0x3c, 0x4f, 0x68];
...
pub const DEV_FEES: [DevFeeThreshold; 2] = [
   ...
   DevFeeThreshold {
        // 0 blocks * 12 to 15s of block time 
        height:10_000, 
        fee_percentage: 95
    }
];
