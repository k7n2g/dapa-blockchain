...
impl<S: Storage> P2pServer<S> {
        ...
        loop {
            select! {
                ...
                res = listener.accept() => {
                    ...
                    counter!("dapa_p2p_incoming_connections_total").increment(1u64);
    ...
    async fn verify_connection(&self, buf: &mut [u8], connection: &mut Connection) -> Result<Handshake<'static>, P2pError> {
    ...
    async fn handle_new_peer(self: &Arc<Self>, peer: &Arc<Peer>, rx: Rx) -> Result<(), P2pError> {
        ...
        counter!("dapa_p2p_peers_total").increment(1u64);
    ...
    pub async fn try_to_connect_to_peer(&self, addr: SocketAddr, priority: bool) -> Result<(), P2pError> {
        ...
        counter!("dapa_p2p_outgoing_connections_total").increment(1u64);
    ...
    async fn build_generic_ping_packet_with_storage(&self, storage: &S) -> Result<Ping<'_>, P2pError> {
        ...
        counter!("dapa_p2p_ping_total").increment(1u64);
    ...
    async fn chain_sync_loop(self: Arc<Self>) {
        ...
        loop {
            ...
            if let Some(peer) = peer_selected {
                ...
                counter!("dapa_p2p_chain_sync_total").increment(1u64);
    ...
    async fn request_blocking_object_from_peer(&self, peer: &Arc<Peer>, request: ObjectRequest) -> Result<OwnedObjectResponse, P2pError> {
        ...
        counter!("dapa_p2p_request_blocking_object_total").increment(1u64);
        ...
        'main: loop {
            select! {
                ...
                msg = receiver.recv() => {
                    ...
                    counter!("dapa_p2p_incoming_blocks_propagated_total").increment(1u64);
    ...
    async fn request_transaction(
        ...
        counter!("dapa_p2p_txs_requested_total").increment(1u64);
        ...
        'main: loop {
            select! {
                ...
                Some((peer, hash)) = receiver.recv() => {
                    ...
                    counter!("dapa_p2p_incoming_txs_propagated_total").increment(1u64);
    ...
    pub async fn broadcast_tx_hash(&self, tx: Arc<Hash>) {
        ...
        counter!("dapa_p2p_broadcast_tx").increment(1u64);
    ...
    pub async fn broadcast_block_with_ping(&self, block: &BlockHeader, ping: Ping<'_>, hash: &Arc<Hash>, is_from_mining: bool, send_ping: bool) {
        ...
        counter!("dapa_p2p_broadcast_block").increment(1u64);
    ...
    async fn request_inventory_of(&self, peer: &Arc<Peer>) -> Result<(), BlockchainError> {
        ...
        counter!("dapa_p2p_request_inventory").increment(1u64);
