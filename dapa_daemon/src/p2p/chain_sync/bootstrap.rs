    ...
    pub async fn handle_bootstrap_chain_request(self: &Arc<Self>, peer: &Arc<Peer>, request: BootstrapChainRequest<'_>) -> Result<(), BlockchainError> {
        ...
        let response = match request {
            ...
            StepRequest::Assets(min, max, page) => {
                ...
                histogram!("dapa_p2p_assets_ms").record(start.elapsed().as_millis() as f64);
            ...
            StepRequest::KeyBalances(key, min, max, page) => {
                ...
                histogram!("dapa_p2p_key_balances_ms").record(start.elapsed().as_millis() as f64);
            ...
            StepRequest::SpendableBalances(key, asset, min, max) => {
                ...
                histogram!("dapa_p2p_spendable_balances_ms").record(start.elapsed().as_millis() as f64);
