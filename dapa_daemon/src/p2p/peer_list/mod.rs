...
pub struct PeerListEntry {
    ...
    // Mark it as true if we were ever able to connect
    // as an outgoing peer
    out_success: bool,
...
impl PeerList {
    ...
    pub async fn remove_peer(&self, peer_id: u64, notify: bool) -> Result<(), P2pError> {
        ...
        gauge!("dapa_p2p_peers_current").set(peers.len() as f64);
    ...
    pub async fn add_peer(&self, peer: &Arc<Peer>, max_peers: usize) -> Result<(), P2pError> {
        ...
        gauge!("dapa_p2p_peers_current").set(count as f64);
...
impl PeerListEntry {
    fn new(local_port: Option<u16>, state: PeerListEntryState, out_success: bool) -> Self {
        Self {
            first_seen: None,
            last_seen: None,
    ...
    fn set_out_success(&mut self, success: bool) {
        self.out_success = success;
    }

    fn is_out_success(&self) -> bool {
        self.out_success
    }
...
impl Serializer for PeerListEntry {
    ...
    fn read(reader: &mut Reader) -> Result<Self, ReaderError> {
        ...
        let out_success = reader.read_bool()?;
