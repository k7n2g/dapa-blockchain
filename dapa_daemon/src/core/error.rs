...
pub enum BlockchainError {
    ...
    #[error("Invalid Tx fee, expected at least {}, got {}", format_dapa(*_0), format_dapa(*_1))]
    InvalidTxFee(u64, u64),
    #[error("Fees are lower for this TX than the overrided TX, expected at least {}, got {}", format_dapa(*_0), format_dapa(*_1))]
